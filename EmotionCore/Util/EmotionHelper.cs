...
namespace EmotionCore.Util
{
    public class EmotionHelper
    {
        ...
        public EmotionHelper(string apiKey)
        {
            emoClient = new EmotionServiceClient(apiKey);
        }
        ...
        private ObservableCollection<EmoFace> ExtractFaces(Emotion[] emotions, EmoPicture emoPicture)
        {
            ...
            foreach (var emotion in emotions)
            {
                ...
                emoface.Emotions = ProccessEmotions(emotion.Scores, emoface);
        ...
        private ObservableCollection<EmoEmotion> ProccessEmotions(EmotionScores scores, EmoFace emoface)
        {
